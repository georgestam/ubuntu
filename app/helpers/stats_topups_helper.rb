module StatsTopupsHelper
  ...
  def top_10_customers_with_topups(order)
    ...
    bar_chart top_10_data, id: order == "asc" ? "top-10-customers-with-more-topups" : "Bottom-40-customers-with-less-topups",  xtitle: "", ytitle: "", library: basic_opts_without_decimals(order == "asc" ? "Top 10 customers with more topups" : "'Bottom 40 customers with less topups'")
  end 
  ...
  def top_10_customers_with_topups_in_time
    ...
    line_chart top_data, legend: "bottom", xtitle: "", ytitle: "", library: basic_opts('Top 10 customers with more topups per week')
  end 
